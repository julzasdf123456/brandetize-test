  ...
  return (
    <>
      <div className="flex lg:flex-row md:flex-row flex-col lg:min-h-screen">
        <div className="flex-1 flex flex-col lg:pt-[41px] lg:px-[145px] md:px-[70px] md:pt-[30px] hidden sm:block">
          ...
          <div className="h-full flex flex-col justify-center inline-block">
            <h1 className="text-left font-playfair font-bold lg:text-[65px] md:text-[36px] text-[#4b4334] title-line-height">
